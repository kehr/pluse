...
import (
	...
	"github.com/kehr/pluse/internal/event"
	"github.com/kehr/pluse/internal/permission"
	"github.com/kehr/pluse/internal/pubsub"
	"github.com/kehr/pluse/internal/stringext"
	cmpChat "github.com/kehr/pluse/internal/tui/components/chat"
	"github.com/kehr/pluse/internal/tui/components/chat/splash"
	"github.com/kehr/pluse/internal/tui/components/completions"
	"github.com/kehr/pluse/internal/tui/components/core"
	"github.com/kehr/pluse/internal/tui/components/core/layout"
	"github.com/kehr/pluse/internal/tui/components/core/status"
	"github.com/kehr/pluse/internal/tui/components/dialogs"
	"github.com/kehr/pluse/internal/tui/components/dialogs/commands"
	"github.com/kehr/pluse/internal/tui/components/dialogs/filepicker"
	"github.com/kehr/pluse/internal/tui/components/dialogs/models"
	"github.com/kehr/pluse/internal/tui/components/dialogs/permissions"
	"github.com/kehr/pluse/internal/tui/components/dialogs/quit"
	"github.com/kehr/pluse/internal/tui/components/dialogs/sessions"
	"github.com/kehr/pluse/internal/tui/page"
	"github.com/kehr/pluse/internal/tui/page/chat"
...
func (a *appModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case pubsub.UpdateAvailableMsg:
		...
		statusMsg := fmt.Sprintf("Pluse update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			statusMsg = fmt.Sprintf("This is a development version of Pluse. The latest version is v%s.", msg.LatestVersion)
		}

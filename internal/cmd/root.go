...
import (
	...
	"github.com/kehr/pluse/internal/tui"
...
func init() {
	...
	rootCmd.PersistentFlags().StringP("data-dir", "D", "", "Custom pluse data directory")
...
var rootCmd = &cobra.Command{
	...
	Long: `Pluse is a powerful terminal-based AI assistant that helps with software development tasks.
...
pluse -d -c /path/to/project

# Run with custom data directory
pluse -D /path/to/custom/.pluse
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Pluse crashed. If metrics are enabled, we were notified about it. If you'd like to report it, please copy the stacktrace above and open an issue at https://github.com/kehr/pluse/issues/new?template=bug.yml") //nolint:staticcheck
		}
		return nil
	},
...
func setupApp(cmd *cobra.Command) (*app.App, error) {
	...
	if err := createDotPluseDir(cfg.Options.DataDirectory); err != nil {
		return nil, err
	}
...
func shouldEnableMetrics() bool {
	if v, _ := strconv.ParseBool(os.Getenv("PLUSE_DISABLE_METRICS")); v {
		return false
	}
...
func createDotPluseDir(dir string) error {

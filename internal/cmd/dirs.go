...
var dirsCmd = &cobra.Command{
	Use:   "dirs",
	Short: "Print directories used by Pluse",
	Long: `Print the directories where Pluse stores its configuration and data files.
...
var configDirCmd = &cobra.Command{
	Use:   "config",
	Short: "Print the configuration directory used by Pluse",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfig()))
	},
}
...
var dataDirCmd = &cobra.Command{
	Use:   "data",
	Short: "Print the datauration directory used by Pluse",
	Run: func(cmd *cobra.Command, args []string) {
		cmd.Println(filepath.Dir(config.GlobalConfigData()))
	},
}
